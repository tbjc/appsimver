    ...
    companion object{
        ...
        fun FuncionApi():ApiService{
            ...
            val retrofit: Retrofit = Retrofit.Builder()
                .baseUrl("https://pruebaapiproyect.000webhostapp.com/")
        ...
        fun puntoEnPoligono(nvert:Int, vertx:ArrayList<Double>, verty:ArrayList<Double>, testx:Double, testy:Double ):Boolean{
            ...
            while (i < nvert){
                Log.e("revision2:","i:${i}, j:${j}, c:${c}, vertx[i]:${vertx[i]}, vertx[j]:${vertx[j]}, verty[i]:${verty[i]}, verty[j]:${verty[j]},  testx: ${testx}, testy: ${testy}")
